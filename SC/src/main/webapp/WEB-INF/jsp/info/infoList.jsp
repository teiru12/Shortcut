					...
					<div class="col-lg-12 col-md-12">
						<div class="card">
							...
							<div class="card-content">
								<a href="infoWriteForm.cut" class="btn btn-outline-primary" style="float: right; margin-right: 25px;">글쓰기</a>
								<div class="card-body">
									<table class="table">
										<tr>
										...
										<c:if test="${empty noticeTopList and empty infoList}">
											<tr>
											...
											<c:choose>
												...
												<c:when test="${infoItem.ISDEL == 'N'}">
													<tr>
														...
														<td class="list-group-horizontal-sm"><fmt:formatDate pattern="yyyy-MM-dd" value="${infoItem.INFODATE }" /></td>
													</tr>
												</c:when>
									...
									<form action="infoList.cut">
										<div class="col-md-3 mb-1" style="float: right;">
											<div class="input-group mb-3">
												<span class="input-group-text"><i class="bi bi-search"></i></span> <input type="text" name="KEYWORD" id="KEYWORD" value="${KEYWORD}" class="form-control" placeholder="검색어 ...">
